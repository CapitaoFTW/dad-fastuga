...
<template>
  <form class="row g-3 needs-validation" novalidate @submit.prevent="save">
    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="mb-3 checkCompleted">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" v-model="editingTask.completed" id="inputCompleted" />
      ...
      <div class="row mb-3 total_hours" v-show="editingTask.completed">
        ...
        <div class="col-sm-10">
          <input type="number" class="form-control" id="inputHours" placeholder="Total hours to complete the task"
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="inputDescription" placeholder="Task Description" required
    ...
    <div class="mb-3">
      ...
      <textarea class="form-control" id="inputNotes" rows="4" v-model="editingTask.notes"></textarea>
