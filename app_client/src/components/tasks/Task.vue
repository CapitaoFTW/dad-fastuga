...
<template>
  ...
  <task-detail :operationType="operation" :task="task" :errors="errors" :projects="projectsStore.projects"
    :fixedProject="fixedProject" @save="save" @cancel="cancel"></task-detail>
</template>